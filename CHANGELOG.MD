...
# 0.0.7 Release:
## API Update Notes:
- Added utils: `effectUtils.resetDuration`, `rollUtils.replaceRollShowDiscarded`, `rollUtils.setTotalWithBonus`, `workflowUtils.updateTargets`, and several confirm dialog helpers for different localized prompts.
## Bug Fixes:
