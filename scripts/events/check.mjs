...
async function targetSituational(actor, data) {
    return await new Events.CheckEvent(actor, constants.rollPasses.targetSituational, data).run();
}
async function context(actor, data) {
    ...
    if (selections.length) {
        ...
        const selection = await DialogApp.dialog('CAT.Check.Title', undefined, inputs, 'okCancel');
